import { DocHeader, DocFooter } from "../docs/DocShell";

export const metadata = {
  title: "Harriett Workflow and System Map | Prairie Dog Labs",
};
...
function Phase({ label }: { label: string }) {
  const colors: Record<string, string> = {
    ...
    "Not yet": "bg-ink/8 text-stone",
    "Demo sandbox": "bg-gold/20 text-ink",
  };
    ...
    <div className="min-h-screen bg-paper print:bg-white">
      ...
      <main className="mx-auto max-w-4xl px-8 py-12 print:py-6">
        ...
        <Section id="integrations" title="Integration Dependency Map" pageBreak>
          <p className="text-sm text-stone mb-8 leading-relaxed">
            Every account or service connection required, organized by when it is needed.
          </p>
              ...
              <table className="w-full">
                ...
                <tbody className="bg-offwhite divide-y divide-ink/6">
                  {[
                    ...
                    ["A2P 10DLC registration", "Legal requirement for business SMS in the US", "Brand + campaign registration through Twilio", "Submit Day 1 of Phase 2. Approval takes 2-4 weeks."],
