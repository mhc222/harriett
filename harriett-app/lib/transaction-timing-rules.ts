...
export const TRANSACTION_TIMING_RULES: TransactionTimingRule[] = [
  ...
  },
  {
    ...
    offsetDays: 5,
    offsetBusinessDays: null,
    dueTimingText: "Within 5 days unless contract says otherwise",
  ...
  },
  {
    ...
    offsetDays: 14,
    offsetBusinessDays: null,
    dueTimingText: "Contract controls, fallback reminder at 14 to 21 days",
  ...
  },
  {
    ...
    offsetDays: 21,
    offsetBusinessDays: null,
    dueTimingText: "Typical 21 to 30 days",
  ...
  },
  {
    ...
    jurisdiction: "PM",
    sourceType: "office_policy",
    title: "FHA clause re-execution",
    trigger: "Loan type changes to FHA",
    anchor: "loan_type_change_date",
    offsetDays: 0,
    offsetBusinessDays: null,
    dueTimingText: "Same day or immediately after loan-type change",
